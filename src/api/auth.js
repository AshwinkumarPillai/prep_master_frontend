...
export const fetchFullTestDetails = (payload) => httpClient.post("/test/fetchFullTest", payload);
...
export const fetchUserHistory = (payload) => httpClient.post("user/fetchUserHistroy", payload);
